...
#define PLAYM4_ORDER_ERROR \
  2                               // The order of the function to be called is
                                  // error.
...
#define PLAYM4_EXTRACT_NOT_SUPPORT \
  27                                     // Don't support the version of this
                                         // file.
...
typedef struct _SYSTEMTIME {
  WORD wYear;          // 年份（1601-30827）
  WORD wMonth;         // 月份（1-12）
  WORD wDayOfWeek;     // 星期（0=星期日，1=星期一，...，6=星期六）
  WORD wDay;           // 日期（1-31）
  WORD wHour;          // 小时（0-23）
...
typedef struct _HIK_MEDIAINFO_  // modified by gb 080425
{
  ...
  unsigned short
      media_version;  // �汾�ţ�ָ����Ϣ�ṹ�汾�ţ�ĿǰΪ0x0101,��1.01�汾��01�����汾�ţ�01���Ӱ汾�š�
...
PLAYM4_API BOOL __stdcall PlayM4_SetDisplayCallBackYUV(
    LONG nPort, void(CALLBACK* DisplayCBFun)(DISPLAY_INFO_YUV* pstDisplayInfo),
    BOOL bTrue, void* pUser);
...
// lpDriverDescription,DWORD nDespLen,LPSTR lpDriverName ,DWORD
// nNameLen,HMONITOR *hhMonitor);
...
// PLAYM4_API BOOL __stdcall PlayM4_SetDisplayRegion(LONG nPort, DWORD
// nRegionNum,
//                                                   RECT* pSrcRect, HWND
//                                                   hDestWnd, BOOL bEnable);
...
// PLAYM4_API BOOL __stdcall PlayM4_SetDecodeERC(long nPort, unsigned int
// nLevel);
...
typedef struct tagFECParam {
  ...
  unsigned int
      nPlaceAndCorrect;  // ��װ��ʽ�ͽ�����ʽ��ֻ�����ڻ�ȡ��SetParam��ʱ����Ч,��ֵ��ʾ��װ��ʽ�ͽ�����ʽ�ĺ�
